...
cd(depsdir) do
    ...
    autotools_install("http://prdownloads.sourceforge.net/tcl/tcl8.6.0-src.tar.gz","tcl-8.6.0.tar.gz",["--enable-64bit","--enable-threads","--enable-symbols"],"tcl8.6.0/unix","libtcl8.6.$shlib_ext")
    autotools_install("http://prdownloads.sourceforge.net/tcl/tk8.6.0-src.tar.gz","tk-8.6.0.tar.gz",["--enable-symbols","--enable-64bit","--enable-threads","--enable-aqua=yes","--with-tcl="*joinpath(prefix(),"lib")],"tk8.6.0/unix","libtk8.6.$shlib_ext")
